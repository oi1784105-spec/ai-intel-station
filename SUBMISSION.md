...
未完成或未验证事项：
  ...
  3. 已知限制：
     · 配图率 26.1%（395 条中 103 条）是「不额外请求文章页」约束下的天花板；
     · 近 7 天运行成功率 0.6667（口径：整轮无失败源的轮次占比，14/21；按源次计则为 329/336 = 97.9%）——
...
| 演示地址 | <https://oi1784105-spec.github.io/ai-intel-station/> | 线上实测 HTTP 200、637,593 字节、`sha256:5a5425fd97b8a0b1`，与本地 `dist/index.html` **字节级完全一致**（已是第四版，含手机端报头与字号修订） |

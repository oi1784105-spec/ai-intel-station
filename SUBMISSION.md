...
未完成或未验证事项：
  ...
  3. 已知限制：
     · 配图率 25.4%（299 条中 76 条）是「不额外请求文章页」约束下的天花板；
     · 近 7 天运行成功率 0.6316（口径：整轮无失败源的轮次占比，12/19；按源次计则为 297/304 = 97.7%）——
...
| 演示地址 | <https://oi1784105-spec.github.io/ai-intel-station/> | 线上实测 HTTP 200、516,581 字节、`sha256:1e936ea5c68d8184`，与本地 `dist/index.html` **字节级完全一致**（已是第二版） |
